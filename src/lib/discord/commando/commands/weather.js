exports.run = async (client, msg, command) => {
	...
	try {
		...
		if (client.config.discord.admins.includes(msg.author.id) && msg.channel.type === 'GuildText') target = { id: msg.channel.id, name: msg.channel.name, webhook: false }
		...
		if (!isRegistered && client.config.discord.admins.includes(msg.author.id) && msg.channel.type === 'GuildText') {
