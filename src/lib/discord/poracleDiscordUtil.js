...
class PoracleDiscordUtil {
	...
	async buildTarget(args) {
		...
		if (this.options && this.options.targetOverride) {
			...
			if ((this.msg.msg.channel.type === 'GuildText' || this.msg.msg.channel.type === 'GuildNews') && (this.msg.isFromAdmin || this.permissions.channelTracking)) {
				target = {
			...
			if (!status.isRegistered && (this.msg.isFromAdmin || this.permissions.channelTracking) && (this.msg.msg.channel.type === 'GuildText' || this.msg.msg.channel.type === 'GuildNews')) {
